# SHOECART - NIIT Project 1
**[Project Demo Video](http://tiny.cc/shoecart)**

This Ecommerce project is built using Spring, Hibernate ORM and Spring security consisting of basic funtionality like
  1.    New user registrations
  2.   Different views for user and admin
  3.   View individual category items
  4.   View individual item
  5.   Add to cart
  6.   View cart
  7.   Add category, supplier and products (Only admin)
...
-  **Download Project** [here](https://github.com/vamshinathreddy546/shoecart/archive/master.zip)
...
-	**Eclipse Mars**
    ...
    [Click here to download Eclipse Mars](http://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/mars/2/eclipse-jee-mars-2-win32-x86_64.zip&mirror_id=448)
